...
public class ITestFileContentEquals {
    ...
    public static void setUp() {
        ...
        try {
            ...
            //creating processors
            splitProcessor = new FileProcessor(specifiedFile.getAbsolutePath(), partSize, interrupt, paramHolder, iteratorFactory, taskFactory, statisticFactory);
            splitProcessor.process();
            mergeProcessor = new FileProcessor(partName, interrupt, paramHolder, iteratorFactory, taskFactory, statisticFactory);
